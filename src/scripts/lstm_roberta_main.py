"""
Script for training and evaluating the hybrid LSTM-RoBERTa sentiment analysis model.
"""
...
from utils.lstm_roberta_classifier import HybridSentimentClassifier
...
def main():
    """Main function to run the hybrid LSTM-RoBERTa model."""
    # Parse command line arguments
    parser = argparse.ArgumentParser(description="Train/Test hybrid LSTM-RoBERTa sentiment analysis model")
    ...
    parser.add_argument(
        ...
        type=bool,
        default=True,
        help="Whether to freeze RoBERTa parameters"
    )
    ...
    try:
        ...
        if args.mode == 'test':
            model_path = os.path.join(src_dir, 'models', 'lstm_roberta_model.pt')
        ...
        # Save results
        model_params = {
            'model_type': 'LSTM-RoBERTa',
            'roberta_model': model.roberta_model,
            'hidden_dim': model.hidden_dim,
            'num_layers': model.num_layers,
            'dropout': model.dropout,
            'freeze_roberta': model.freeze_roberta,
            'batch_size': args.batch_size,
            'max_length': args.max_length,
            'epochs': args.epochs,
            'learning_rate': args.learning_rate,
